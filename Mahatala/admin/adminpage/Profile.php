...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <section class='col-md-5' style='height:100%;'>
                <img src='../../Client/Bio/".$result["IMG"]."' class='upload-click' style='height:100%; backgorund-color:grey; padding-bottom:50px; width:100%;' id='sorc'>
    ...
    <script type="text/javascript">
            ...
            $("#admin>section:last-child").click(function(){
                alert('hai');
                $("#submit").show();
            });
            $("#submit").click(function(){
                ...
                alert($("#Comname").val());
                mdata.append("Comname",$("#Comname").html());
