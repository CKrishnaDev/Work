...
<script>
  $(document).ready(function() {
    ...
    var nicesx = $("body").niceScroll({cursorwidth:8,scrollspeed:300});
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<div class='mahacontainer'>
		<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style='display:hidden;'>
	        <div>
	            ...
	            <div class="fullwidth collapse navbar-collapse navbar-main-collapse">
			      <ul id='MenuAtas' class="togglet fullwidth nav navbar-nav thumb-nav">
...
<section id='service' class='intro GreyColor Scolor padding-btm-10x padding-bt-10x' style='padding-top:180px; position:relative; overflow:hidden;'>
		<div id='parel' class='intro fullwidth backgroundservice image' data-parallax='{"x": 180}' style='position:absolute; top:0px; left:0px'>
		...
		<div class='paralaxMenu'>
			...
			<ul id='ServiceR' style='color:#708090; padding-top:30px;'>
					...
					<li data-member='SD' data-id='2' data-color='colorRed'>
						<div class='ulala'>
							<div class='main'>
								<div id='Test'>Software</div><div>Development</div>
							</div>
							<div class='submain'>SD</div>
						</div>
					</li>
					<li data-member='NW' data-id='3' data-color='colorBlue'>
						<div class='ulala'>
							<div class='main'>
								<div id='ulalates'>Networking</div><div id='Test2'>Solution</div>
							</div>
							<div class='submain'>NWS</div>
						</div>
					</li>
					<li data-member='WD' data-id='1' data-color='colorGreen'>
						<div class='ulala'>
							<div class='main'>
								<div id='Test3'>Website</div> <div id='ulalatesyeah'>Design</div>
							</div>
							<div class='submain'>WD</div>
						</div>
					</li>
					<li data-member='EDP' data-id='4' data-color='colorYellow'>
						<div class='ulala'>
							<div class='main'>
								<div class='spacees'>Electronic</div> <div id='UlalaTea'>Device</div> <div class='spaceet'>Procurment</div>
							</div>
							<div class='submain'>EDP</div>
						</div>
					</li>
			</ul>
...
<!--Work Start-->
<section id='work' class='intro padding-btm-10x padding-bt-10x' style='position:relative; overflow:hidden;'>

	<div class='fullwidth container'>

        <!-- Portfolio Projects -->
        <div class="col-md-12" id='projected' style='position:relative;'>
        ...
        <div class='fullwidth' data-parallax='{"y":150}' style='position:relative; top:-100px;'>
                    	...
                    	echo"<ul class='item activerFlow' style='margin-left:0;'>";?>
							...
							<?php echo" 
									<li class='item-thumbs span3 ".$resut["Kode"]." imageClients'>
									  <div class='seleng hover-wrap signup' data-toggle='modal' data-target='#selengkapnya' data-manipulation='".$resut["IDproject"]."'>
...
<div style='color:black;' class="modal fade disablemodal" id="Pricing" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	  <div class="fullwidth">
	  	...
	  	var globalo;
	  	$(document).ready(function(){
	  		var scriptt="<div class='uyuol close'><i class='fa fa-close white' data-dismiss='modal' aria-label='Close'></i></div>";
	  		$('.modal').append(scriptt);
...
<!--Price Start-->
<section id='price' class='fullwidth' style='padding-top:50px; padding-bottom:200px; background: url(img/price.png) no-repeat top center !important;
	background-size: cover !important;'>
			<link rel="stylesheet" type="text/css" href="css/pricing.css">
		
            <div class="PriceBack">
                <div class="title-page" style='color:#FFFFFF; margin-bottom:40px;'>
                    <h2 class="title" style='padding-top:0px;'>Price List</h2>
                </div>
            </div>
        
			<div id="pricing-table" class="clear" data-parallax='{"z": 50,"scaleZ":-300,"y":10}' style='height:100%; margin-top:0px;'>
...
<section id='about' class='intro AboutBg' style='padding:75px 0px; color:#000000; height:auto; font-family:Calibri; position:relative; overflow:hidden;'>

	<div class='intro container fullwidth' style='position:relative; left:-200px;' data-parallax='{"x": 300,"scaleX":1,"distance":300}'>
		<div class='col-md-12' >
			<?php
			...
			<section class='col-md-5'>
				<img src='Client/Bio/".$result["IMG"]."' style='min-width:200px; max-width:350px; max-height:400px; padding-bottom:50px;'>
			</section>
			</section>
...
<section id='scope' class='row fullwidth' style='background-color:#336666;  margin:0px;height:auto; position:relative; overflow:hidden;'>
	<div style='z-index:800;'>
	  <div class='col-md-12 ' style='color:#FFFFFF;'>
	  		<h2 class='page-header text-center' style='padding-top:30px;' data-parallax='{"y": 50,"easing": "easeOutBack", "easing-return": "easeInOutBack","distance":800,"duration":300}'>Details</h2>
	  </div>
	  <div class='col-md-12' style='padding-bottom:50px;'>
	  		<div class='col-md-12'>
	  			...
	  			for($i=0;$i<45;$i+=15){
	  				...
	  				while($result=mysql_fetch_array($sql)){
	  					echo"
	  						<li class='listing' ><a style='color:#FFFFFF;'><i class='fa fa-pencil'></i><span style='padding-left:15px;'>".$result["Nama"]."</span></a></li>
	  					";
	  				}
		  			echo"</ul>";
		  		}
...
<!-- Modal -->
<div class="modal fade" id="testimoniModal" tabindex="-1" role="dialog" style='position:relative;' aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <script type="text/javascript">
        	...
        	<div ><center>
        	<button type="button" class="btn btn-info signup" data-toggle='modal' data-target="#testimoniModal" style='background-color:#FFCC00; background-image: linear-gradient(to bottom,#FFCC00,#FFCC00); color:#000000; font-weight:800;'><i class='fa fa-plus'>&nbspGive Testimon</i></button>
        	</div></center>
    </div>
    <ul class="timeline">
    	<?php
